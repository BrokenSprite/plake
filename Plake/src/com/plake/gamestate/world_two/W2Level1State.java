package com.plake.gamestate.world_two;
...
public class W2Level1State extends GameState {
	...
	public W2Level1State(GameStateManager gsm) {
		super(gsm);
		this.gsm = gsm;
		gsm.setPaused(false);
		init();
	...
	public void init() {
		...
		tileMap.loadTiles("/Tilesets/ruinstileset.gif");// TODO FLAG
		tileMap.loadMap("/Maps/w2_lvl1.map");// TODO FLAG
		tileMap.setPosition(0, 0);
		tileMap.setTween(0.07);
		bg = new Background("/Backgrounds/grassbg1.gif", 0.1);// TODO FLAG
	...
	private void populateEntity() {
		...
		Point[] points3 = new Point[] { new Point(165, 140) };
