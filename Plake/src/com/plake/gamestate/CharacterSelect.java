...
public class CharacterSelect extends GameState {
	...
	private BufferedImage left, right, enter, greendrag, kat, bluedrag, purpledrag,/*
																		 * comingsoon
																		 * ,
																		 * soontitle
																		 * ,
	...
	public CharacterSelect(GameStateManager gsm) {
		...
		try {
			...
			purpledrag = ImageIO.read(getClass().getResourceAsStream("/Sprites/Menu/purpledrag.gif"));
