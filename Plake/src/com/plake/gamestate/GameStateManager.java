...
public class GameStateManager {
	...
	public static final int LOADINGSTATE = 12;
	...
	/*
	 * public void nextLevel() { LevelCompletedState.eDead = 0;
	 * LevelCompletedState.score = 0;
	 * 
	 * if (l1beat) { l1beat = false; setState(4); } else if (l2beat) { l2beat =
	 * false; setState(5); } else if (l3beat) { l3beat = false; setState(6); }
	 * else if (l4beat) { l4beat = false; setState(9); } else if (l5beat) {
	 * l5beat = false; setState(10); } else if (w2_l1beat) { w2_l1beat = false;
	 * setState(0); }
	 * 
	 * }
	 */
