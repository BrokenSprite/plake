...
public class Player extends MapObject {
	...
	public Player(TileMap tm) {
		...
		sfx.put("playerlands", new AudioPlayer("/SFX/playerlands.mp3"));
	...
	public void setDead(boolean dead) {
		this.dead = dead;
		health = 0;
		LevelCompletedState.lives = 0;
		setPosition(100, 100);
		dead = false;
		stop();
		health = 5;
		LevelCompletedState.lives = 5;
		fire = 2500;
	}
	...
	private void getNextPosition() {
		...
		if (falling) {
			...
			if (dy > 0) {
				jumping = false;
				sfx.get("playerlands").play();//TODO Remove if negative feedback
			}
