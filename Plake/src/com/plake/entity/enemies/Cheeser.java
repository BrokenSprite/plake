...
public class Cheeser extends Enemy {

	private BufferedImage[] sprites;

	public Cheeser(TileMap tm) {
		super(tm);
		...
		try {
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/cheeser.gif"));
